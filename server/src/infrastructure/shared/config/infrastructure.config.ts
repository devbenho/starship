...
const GlobalConfig = Object.freeze({
  ...
  STORE_SESSIONS_IN_CACHE:
    getEnvironmentString('SESSIONS_STORAGE', 'cache') !== 'db',

  STORE_SESSIONS_IN_DB:
    getEnvironmentString('SESSIONS_STORAGE', 'cache') === 'db',
...
const DatabaseConfig = Object.freeze({
  ...
  DB_NAME: getEnvironmentString('DB_NAME', 'BugZoneDB'),
  MONGO_URI: getEnvironmentString('MONGO_URI', 'mongodb://localhost:27017/BugZoneDB'),
});
